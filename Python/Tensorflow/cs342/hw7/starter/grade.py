...
_ = tf.contrib.data.Iterator # small hack to make sure tf.contrib gets loaded, see https://groups.google.com/a/tensorflow.org/forum/#!topic/discuss/6JY7xEknrSo
